...
このボタンは後述するセンタークリックにも使用するため、キーオフ時に軸切り替えが行われるようにしています<br>
X軸移動のみでは「メタルオレンジEX」のメニュー操作ができなかったので追加しました<br>

### センターボタンについて
センターボタンについては**X/Y軸切り替え**ボタンを押しながら**右または左**ボタンを押すことでクリックとなります<br>
センタークリックが成立した場合はX/Y軸切り替えボタンキーオフ時の軸切り替えは行われません<br>
また、現在のメイン基板では配線されていませんが、picoのPIN20(GP15) - GND(PIN18あたりがおすすめ)間にスイッチを付けていただくとセンターボタンとして機能するようにしています<br>
センタースイッチを独立して実装される場合はこちらをご利用ください<br>
